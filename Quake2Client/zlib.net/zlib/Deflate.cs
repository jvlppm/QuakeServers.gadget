namespace zlib
{
    ...
    public sealed class Deflate
    {
        ...
        internal bool _tr_tally(int dist, int lc)
        {
            ...
            if (dist == 0)
            {
                (numArray = this.dyn_ltree)[(int) (ptr = (IntPtr) (lc * 2))] = (short) (numArray[(int) ptr] + 1);
            }
            else
            {
                this.matches++;
                dist--;
                (numArray = this.dyn_ltree)[(int) (ptr = (IntPtr) (((Tree._length_code[lc] + 0x100) + 1) * 2))] = (short) (numArray[(int) ptr] + 1);
                (numArray = this.dyn_dtree)[(int) (ptr = (IntPtr) (Tree.d_code(dist) * 2))] = (short) (numArray[(int) ptr] + 1);
            }
                ...
                if ((++num5 >= num6) || (num3 != num4))
                {
                    ...
                    else
                    {
                        ...
                        if (num3 != 0)
                        {
                            ...
                            {
                                IntPtr ptr;
                                (numArray = this.bl_tree)[(int) (ptr = (IntPtr) (num3 * 2))] = (short) (numArray[(int) ptr] + 1);
                            }
                            (numArray = this.bl_tree)[0x20] = (short) (numArray[0x20] + 1);
                        }
                        else if (num5 <= 10)
                        {
                            (numArray = this.bl_tree)[0x22] = (short) (numArray[0x22] + 1);
                        }
                        else
                        {
                            (numArray = this.bl_tree)[0x24] = (short) (numArray[0x24] + 1);
                        }
                    }
                    num5 = 0;
                    num2 = num3;
