...
namespace Quake2.Extensions
{
	...
	{
		public static char ReadChar(this ReadRawData data)
		{
			return (char)data.ReadByte();
		}

		public static string ReadQuotedString(this ReadRawData data)
		{
			if (data.ReadChar() != '\"')
			{
		...
		public static byte[] ReadZPacket(this ReadRawData data, int compressedLength, int uncompressedLength)
		{
		...
		public static Package<IClientCommand> ReadClientPackage(this ReadRawData data)
		{
		...
		public static Package<IServerCommand> ReadServerPackage(this ReadRawData data)
		{
			...
			while (!(ignoreEndOfData || data.EndOfData))
			{
				...
				switch (cmd)
				{
					...
					case ServerCommand.ZPacket:
						...
						var compressedPackage = ReadServerPackage(new ReadRawData(data.ReadZPacket(compressedLength, uncompressedLength)));
